...
int main(int argc, char** argv)
{
    ...
    validCommandsName.push_back("michael");
    ...
    validCommandsName.push_back("james");
    validCommandsName.push_back("robert");
    validCommandsName.push_back("scott");
    validCommandsName.push_back("richard");
 //##################################################
    validCommandsName.push_back("angie");
    validCommandsName.push_back("mary");
    validCommandsName.push_back("amy");
    validCommandsName.push_back("kimberly");
    validCommandsName.push_back("lisa");
    validCommandsName.push_back("melissa");
    validCommandsName.push_back("michelle");
    validCommandsName.push_back("jennifer");
    validCommandsName.push_back("elizabeth");
    validCommandsName.push_back("julie");
...
cont_z=0;
    while(ros::ok() && !fail && !success)
    {
        ...
        {  
            ...
            case SM_INIT:    
                JustinaHRI::loadGrammarSpeechRecognized("receptionist.xml");//load the grammar
                JustinaHRI::waitAfterSay("Welcome , starting receptionst test", 200);
                JustinaHRI::enableSpeechRecognized(false);//disable recognized speech
                //JustinaManip::startHdGoTo(0.0, 0.0);
                JustinaHRI::waitAfterSay("Hello!, please stand in front of me so I can learn  your face.", 3000);
                ...
                if(faces.recog_faces.size()==0)
                {
                    ...
                    JustinaHRI::say("I now know your face");
                    ros::Duration(1.0).sleep();
            ...
            case SM_RECOG_NAMES:        
                std::cout <<"faces.eges: "<<faces.recog_faces[0].face_centroid.y <<std::endl;
            ...
            case SM_GO_TO_LIVING_ROOM:
                JustinaHRI::waitAfterSay("Please stay behind me  and follow me, I going to introduce you to John", 1000);
            ...
            break;
           case SM_GO_TO_INIT:
                JustinaHRI::waitAfterSay(" ", 100);
                JustinaHRI::waitAfterSay("I going back to the door", 500);
                if(!JustinaNavigation::getClose("init", 200000))
                    if(!JustinaNavigation::getClose("origen", 200000))
                        JustinaNavigation::getClose("origen", 200000);
